...
**Konfigurasi Sniper**: Kapasitas `5 Slot` | Target TP `Order Book` | Stop Loss `Support wall` | Max Hold `130s` | Observasi `10s`
**Order Book Strategy**: mode `full` — TP/CL ditentukan wall support/resistance; persentase hanya emergency.
...
| 14:58:57 | **AADI** | `BREAKOUT_MOMENTUM` | 12400 | 10s | Timeout 10s: Momentum padam. Abort! |
