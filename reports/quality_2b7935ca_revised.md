...
- **Selisih Timestamp (Received At minus timestamp transaksi; bukan latensi jaringan terverifikasi)**:
  ...
  - Selisih negatif: dedicated=3280, wildcard=3268; perbedaan jam/makna timestamp belum dikoreksi.
...
- **Pasangan Event Bertimestamp Sama (dapat berasal dari satu pesan)**: 10,094 event (46.39%)
- **Jeda Terpanjang Antar-event**: 9698 ms
