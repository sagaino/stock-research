...
| **Laba Bersih (Net Profit/Loss)** | **+Rp 13,589** | **Profit bersih final masuk ke akun trading** |
| **Laba Kotor (Gross Profit/Loss)**| +Rp 15,800 | Akumulasi selisih harga jual dikurangi harga beli |
| **Total Biaya Broker (Fees Paid)**| Rp 2,211 | Beban komisi transaksi beli & jual |
| **Total Modal Ditransaksikan**    | Rp 542,800 | Akumulasi perputaran modal dari 1 kali transaksi |
| **Win Rate (TP vs CL)**           | **100.0%** | Rasio kemenangan posisi yang terdeterminasi |
| **Take-Profit (TP Hit)**          | **1** (100.0%) | Target profit tercapai (+3.0% s/d +4.0%) |
...
| **Rata-rata Profit (Avg Win)**    | **+2.91%** | Rata-rata persentase gain posisi TP |
| **Rata-rata Rugi (Avg Loss)**     | **0.00%** | Rata-rata persentase loss posisi CL |
| **Akumulasi Net PnL (%)**         | **+2.91%** | Total persentase PnL seluruh posisi masuk |
...
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|---|
| **MDIA** | 1 | 1 | 0 | 0 | +Rp 15,800 | Rp 2,211 | **+Rp 13,589** | **+2.91%** | Juara Momentum 🚀 |
...
|---|:---:|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|---|
| 15:36:57 | **MDIA** | `BREAKOUT_MOMENTUM` | 23 | Rp 542,800 | 236 | 243 | 243 | 232 | Rp 2,211 | **+Rp 13,589** | **+2.9%** | 892s | `TAKE_PROFIT` | ⚡ Hybrid: T1(12L): TP@240 (+1.7%, Net:+Rp 3,655) | T2(11L): Out@246 (+4.2%, Net:+Rp 9,934) |
